...
class ProductsController extends Controller
{
	...
	public function update(Request $request, $id, Image $image)
	{
		...
		return redirect('/admin/products')->with('message-success', 'Товар ' . $product->name . ' успешно отредактирован.');
		//return redirect()->back()->with('message-success', 'Товар ' . $product->name . ' успешно отредактирован.');
	}
