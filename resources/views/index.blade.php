            ...
            <div class="row">
                ...
                <div class="col-sm-12 feature-map">
                    <div class="feature-map__text right">
                        ...
                        <p>Благодаря тому, что из цепочки изготовитель-потребитель исключены все посредники вы можете выбирать дешевый товар. Низкая стоимость не говорит о плохом качестве. Ценообразующим показателем у нас является только качество товара. Каждый отдельный материал протестирован и допущен к изготовлению игрушек и одежды. Вся Украина оценила низкую стоимость, что и повлекло за собой крупное расширение ассортимента, который вы можете увидеть. Интернет магазин исключает дополнительную надбавку стоимости на коммунальные платежи, транспортные расходы и зарплаты работникам обычного магазина. Покупая в sex shop «Интим», вы платите только за приобретенный товар.</p>
                    </div>
                    <div class="feature-map__img">
                ...
                <div class="col-sm-12 feature-map">
                    <div class="feature-map__text right">
                        ...
                        <p>Только от вас зависит желание удовлетворить свои потребности в половой жизни. Секс шоп предоставляет все необходимое для этого. Пользоваться интимным бельем вполне нормально для мужчины и женщины во всей Украине, поэтому ваш заказ доставят не только в Харьков, но и в любой населенный пункт страны. Улучшите, разнообразьте и украсьте свои достижения в кровати, а мы Вам в этом поможем.</p>
                    </div>
                    <div class="feature-map__img">
