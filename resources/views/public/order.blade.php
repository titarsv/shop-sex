		...
		<div class="row">
			...
			<div class="col-sm-8 col-xs-12">
				...
				<div class="cart__item">
					<div class="cart__item-delete" data-prod-id="{{ $code }}">
						<div></div>
					</div>
			...
			<div class="col-sm-4 col-xs-12" id="liqpay_checkout">
				...
				<form action="{{env('APP_URL')}}/order/create" method="post" class="cart-form" id="order-checkout">
					...
					<p class="cart-form__text">{{ trans('app.your_contact_email') }}<br><small style="font-size: 12px;"><span style="color:#ff3030">*</span> {{ trans('app.obligatory_field') }}</small></p>
					<input class="cart-form__input" type="email" name="email" data-title="Email" data-validate-required="{{ trans('app.obligatory_field') }}">
