...
<section style="margin-bottom: 40px;">
	<div class="container">
		<div class="row">
			...
			<div class="gallery-product col-md-4 col-sm-5 col-xs-12">
				<div class="slick-slider product-slider" data-slick='{"slidesToShow": 1, "arrows":true, "dots": false, "asNavFor": ".product-slider-nav"}'>
				...
				@if(count($gallery) > 1)
				<div class="slick-slider product-slider-thumb product-slider-nav" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "focusOnSelect": true, "arrows":false, "dots": false, "asNavFor": ".product-slider"}'>
					@forelse($gallery as $image)
					@if(is_object($image))
					<div>
			...
			<div class="main-product col-md-8 col-sm-7 col-xs-12">
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="click-buy-popup__container">
						...
						<form action="/sendmail" class="click-buy-popup__form ajax_form" data-error-title="{{ trans('app.send_error') }}" data-error-message="{{ trans('app.try_to_send_a_question_after_a_while') }}" data-success-title="{{ trans('app.thanks_for_the_question') }}" data-success-message="{{ trans('app.our_manager_will_contact_you_soon') }}" data-price="{{ $product->price }}" data-name="{{ $product->name }}" data-sku="{{ $product->articul }}" data-category="{{ $product->category()->name }}">
